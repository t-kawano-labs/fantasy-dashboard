...
from services.data_service import merge_rosters_and_free_agents, merge_all_data, standardize_pitcher_stats, standardize_batter_stats, style_pitcher_stats, style_batter_stats, apply_position_filters, groupby_team
...
if st.sidebar.button("Data Update"):
    ...
    # Fangraphsデータ取得
    df_fg_pitcher = get_projection_data(pitcher_proj_system_value, 'pit')
    df_fg_batter = get_projection_data(batter_proj_system_value, 'bat')
